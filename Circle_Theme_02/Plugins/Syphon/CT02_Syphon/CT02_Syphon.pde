...
/**
 * This is a Processing sketch which has Syphon support and can be used as a
 * Syphon server. It provides controls to change the sketch settings.
 */

private static final String SYPHON_NAME = "CT02_Syphon";  
