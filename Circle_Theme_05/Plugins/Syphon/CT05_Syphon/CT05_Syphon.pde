...
/**
 * This is a Processing sketch which provides controls to change the settings
 * of the sketch. It's based on the 'rotate_05' sketch by David Mrugala and
 * integrates Spout and Syphon. 
 */

private static final String SYPHON_NAME = "CT05_Syphon";  
